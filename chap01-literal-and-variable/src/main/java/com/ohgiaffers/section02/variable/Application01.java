...
public class Application01 {
    public static void main(String[] args){
        ...
        * 변수의 사용 목적
        *   1. 값에 의미를 부여하기 위한 목적
        *   2. 한 번 저장해둔 값을 재사용 하기위한 목적
        *   3. 시간에 따라 변하는값을 저장하고 사용할 수 있다.
        **/
        ...
        System.out.println("1번 고객에게 포인트 110포인트를 지급하였습니다.");
        System.out.println("1번 고객에게 포인트 120포인트를 지급하였습니다.");
        System.out.println("1번 고객에게 포인트 130포인트를 지급하였습니다.");
        System.out.println("1번 고객에게 포인트 140포인트를 지급하였습니다.");
