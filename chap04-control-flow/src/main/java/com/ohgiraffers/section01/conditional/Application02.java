...
// 프로그램내에서 모두가 사용할수있는 Application02라는 클래스를 선언한다
public class Application02 { //Application02의 시작
    // 프로그램이 시작시 바로 사용할 수 있도록 static 영역에 함수를 만들고 문자열 배열의 타입을 가진 args라는 변수를 선언한다.
    public static void main(String[] args) {//main의 시작
        ...
        //dSwitch라는 변수가 가지고 있는 testsimple메소드를 실행한다
