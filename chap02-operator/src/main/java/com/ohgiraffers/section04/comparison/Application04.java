...
public class Application04 {
    public static void main(String[] args){
        ...
        *  '<' : 왼쪽의 피연삱자가 오른쪽의 피연산자보다 작으면 true 아니면 false를 반환한다.
        *  '<=' : 왼쪽의 피연산자가 오른쪽의 피연산보다 작거나 같으면 true 아니면 false를 반환
        * */
        int inum1 = 10;
        int inum2 = 20;
        ...
        System.out.println("inum1과 ium2가 같지 않은지 비교 : " + (inum1 != inum2));
        System.out.println("inum1이 inum2보다 큰지 비교 : "+(inum1> inum2));
        System.out.println("inum1dl iunm2보다 작은지 비교" +(inum1 < inum2));
