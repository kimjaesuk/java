...
public class Application01 {
    public static void main(String [] args){
        ...
        *   1-1 &&(논리 AND) 연산자 : 두개의 논리식 모두 참일 경우 참을 반환, 둘 중 한개라도 거짓인경우 거짓을 반환하는 연산자이다.
        *   1-2 ||(논리 or) 연산자 : 두개의 논리식 중 둘 중 하나라도 참일 경우 참을 반환, 둘다 모두 거짓일 경우 거짓을 반환한다.
        * 2. 논리 부정 연산자 : 피연산자가 하나인 단항연산자로, 피연산자의 결합 방향은 왼쪽에서 오른쪽이다.
        *   2-1 !(논리 Not) 연산자 : 논리식의 결과가 참이라면 거짓을, 거짓이라면 참을 반환한다.
        * */
        System.out.println("true와 true의 논리 anb 연산자 : " +(true && true));
        System.out.println("true와 false 논리 and 연산자 : "+(true && false));
        System.out.println("false와 false 논리 and 연산자 : "+(false && false));

        System.out.println("true와 true 논리 or 연산자 :"+(true || true));
        System.out.println("true와 false의 논리 or 연산자 : "+(false || false));
